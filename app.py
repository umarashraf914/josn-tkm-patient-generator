...
from mosaic_viewer import render_mosaic_tab  # removable: delete this + tab below
...
with st.sidebar:
    ...
    if st.button("🎲 랜덤 생성", width='stretch', type="primary"):
...
# ═══════════════════════════════════════════════════════════════════════════════
# MAIN CONTENT AREA — two tabs: Generator + Mosaic Viewer
# ═══════════════════════════════════════════════════════════════════════════════

st.title("📋 한의 임상시나리오 생성기")
st.caption("한의 임상정보 항목 기반 가상환자 생성 시스템")

# ── Top-level tabs (removable: to remove mosaic tab, delete the second tab) ──
tab_generator, tab_mosaic = st.tabs(["🩺 환자 생성", "📊 확률 모자이크"])

# ═══════════════════════════════════════════════════════════════════════════════
# TAB 2: Mosaic Viewer  (removable block — delete from here to END MOSAIC)
# ═══════════════════════════════════════════════════════════════════════════════
with tab_mosaic:
    render_mosaic_tab()
# ═══════════════════════════════════════════════════════════════════════════════
...
with tab_generator:
    ...
    # ═══════════════════════════════════════════════════════════════════════════════
    st.markdown("---")
    if st.button("✨ 가상환자 시나리오 생성", type="primary", width='stretch'):
